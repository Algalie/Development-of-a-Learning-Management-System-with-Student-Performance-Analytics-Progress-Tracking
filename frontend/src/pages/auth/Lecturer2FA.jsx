...
const Lecturer2FA = () => {
  ...
  const { lecturerVerify2FA } = useAuth();
    ...
    <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: '420px' }}>
          ...
          <FadeIn delay={0.5}>
            ...
            <p style={{
              ...
              Enter the code below to access your lecturer dashboard.
            </p>
      ...
      >
        <div style={{ width: '100%', maxWidth: '440px' }}>
          ...
          <FadeIn delay={0.4}>
            <h1 style={{
              fontSize: '2rem', fontWeight: 800, color: '#0A2A66',
          ...
          <ShakeOnMount>
            <div style={{
              ...
              <div style={{
                ...
                background: 'rgba(16,185,129,0.1)', display: 'flex', alignItems: 'center',
                justifyContent: 'center', margin: '0 auto 1rem',
                fontSize: '1.4rem', color: '#10b981', border: '2px solid rgba(16,185,129,0.2)',
              }}>
                <FaLock />
              </div>

              <h2 style={{
                color: 'var(--text-primary)', fontSize: '1.15rem', fontWeight: 700,
                marginBottom: '3px', textAlign: 'center',
              }}>
                Verification Code
              </h2>
              <p style={{
                color: 'var(--text-muted)', textAlign: 'center', marginBottom: '1.2rem',
                fontSize: '0.82rem',
              }}>
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  color: timeLeft <= 10 ? '#dc2626' : 'var(--text-secondary)',
                }}>
                  ...
                  {digits.map((digit, index) => (
                    <input 
                      ...
                      style={{
                        ...
                        border: `2px solid ${expired ? 'rgba(239,68,68,0.3)' : digit ? '#059669' : 'var(--border)'}`,
                        textAlign: 'center', fontSize: '1.5rem', fontWeight: 700,
                        color: digit ? '#0A2A66' : 'var(--text-primary)', fontFamily: 'monospace',
                        outline: 'none', 
                        background: expired ? 'rgba(239,68,68,0.05)' : digit ? 'rgba(16,185,129,0.04)' : 'var(--input-bg)',
                        transition: 'all 0.2s',
                      }}
                    />
                  ))}
              ...
              <div style={{
                ...
                <FaEnvelope style={{ color: '#10b981', fontSize: '0.8rem' }} />
