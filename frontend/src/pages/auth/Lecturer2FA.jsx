        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
            <div style={{
              ...
              <FaLock style={{ color: '#10b981', fontSize: '1.2rem' }} />
            </div>
          </div>
          ...
          <div style={{
            ...
            <Link to="/lecturer/login" style={{ color: 'var(--text-muted)', textDecoration: 'none', fontSize: '0.8rem', display: 'flex', alignItems: 'center', gap: '4px', fontWeight: 500 }}>
